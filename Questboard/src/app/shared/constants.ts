...
// Valorant required features for tracking kills, deaths, and match info
// See: https://dev.overwolf.com/ow-native/live-game-data-gep/supported-games/valorant/
...
export const GAME_DATA: Record<number, GameData> = {
  765: {
...
export function getRequiredFeaturesForGame(gameId: number): string[] {
  return GAME_DATA[gameId]?.interestedInFeatures ?? REQUIRED_FEATURES;
}
