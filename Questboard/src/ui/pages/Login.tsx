...
export const Login = ({ onGoogleLogin, onSwitchMode, onLogin }: LoginPageProps) => {
    ...
    <div className="min-h-screen bg-slate-950 px-4 py-12 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-md rounded-[2rem] border border-slate-800 bg-slate-900/95 p-8 shadow-2xl shadow-slate-950/40">
        ...
        <div className="relative my-6 flex items-center text-center">
          ...
          <span className="relative inline-flex bg-slate-900 px-3 text-xs uppercase tracking-[0.2em] text-slate-500">Or</span>
        </div>
        ...
        <footer className="mt-6 text-center text-sm text-slate-400">
          ...
          <button type="button" onClick={onSwitchMode} className="ml-2 font-semibold text-sky-400 transition hover:text-sky-300">
            Sign up
          </button>
        </footer>
      </div>
